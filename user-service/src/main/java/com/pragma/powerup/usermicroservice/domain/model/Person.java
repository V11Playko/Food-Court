...
public class Person {
    ...
    public Person(Long id, String name, String surname, LocalDate birthdate, String mail, String phone, String address, String idDniType, String dniNumber, String idPersonType, String password) {
        this.id = id;
        this.name = name;
