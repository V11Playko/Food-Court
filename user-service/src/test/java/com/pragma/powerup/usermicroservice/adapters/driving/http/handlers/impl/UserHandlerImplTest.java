...
import com.pragma.powerup.usermicroservice.domain.usecase.DomainDataTest;
...
class UserHandlerImplTest {
    ...
    @Test
    void saveUser() {
        User user = HttpDataTest.obtainUser();
        UserRequestDto userRequest = HttpDataTest.obtainUserRequest();
